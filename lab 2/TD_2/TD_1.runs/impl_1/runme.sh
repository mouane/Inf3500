...
HD_PWD='X:/Bureau/3500/TD_1/TD_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PartieC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PartieC.tcl -notrace
