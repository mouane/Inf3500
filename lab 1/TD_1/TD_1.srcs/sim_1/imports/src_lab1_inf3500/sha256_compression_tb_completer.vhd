...
begin
    ...
    process
        begin
                 ...
                 wait for 10 ns;
                 assert (CH_R(i) = ch)    
                 report "La fonction Ch est incompatible." severity failure;
                 end loop;
                 end process;
            
     
     UUT2: entity work.Maj
        port map(
            X       =>  x_in, 
            Y        => y_in ,
            Z        => z_in ,
       ...
       process
            begin
                 ...
                 wait for 10 ns;
                 assert (maj = MAJ_R(i))    
                 report "La fonction Maj est fausse." severity failure;
                 end loop;
                end process;
                
     UUT3: entity work.Sigma0
        port map(
                    
             X       =>  x_in,
             Resultat => sigma_lower_0
            );            
        process
                begin
                    for i in 0 to 63 loop
                    ...
                    report "La fonction SIGMA_LOWER_0 est fausse." severity failure;
                    end loop;
             end process;  
      
     
      UUT4: entity work.Sigma1
          port map(
                                       
             X       =>  x_in,
             Resultat => sigma_lower_1
             );
          process
                 begin
                     for i in 0 to 63 loop
                     ...
                     report "La fonction SIGMA_LOWER_1 est fausse." severity failure;
                     end loop;
                 end process; 
                              
     UUT5: entity work.Somme0
        port map(
        
        X       =>  x_in,
        Resultat => sigma_upper_0
        );
        process
            begin
                for i in 0 to 63 loop
                ...
                report "La fonction SIGMA_UPPER_0 est fausse." severity failure;
                end loop;
            end process;
        
        
      UUT6: entity work.Somme1
      port map(
              
              X       =>  x_in,
              Resultat => sigma_upper_1
      ...
      process
                  begin
                      ...
                      report "La fonction SIGMA_UPPER_1 est fausse." severity failure;
                      end loop;
                  end process;
